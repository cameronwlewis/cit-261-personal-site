...
function funkyFunction(disco /* This is a parameter */) {
    ...
    if (regexPattern.test(disco)) document.getElementById("dancing-status").innerHTML = "Let's groove!";else document.getElementById("dancing-status").innerHTML = "Guess we ain't dancin today...";
}
